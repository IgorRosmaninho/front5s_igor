...
import {
  ...
  export default function Organização({navigation}) {
    ...
    const save = async() => { //fazer um post pro back
        ...
        avaliacao.post('/o', {Question_id_answer_o: {notas:[l1,l2,l3,l4], justificativas:[text1,text2,text3,text4] }}).then(response => {console.log(response)})}
                ...
                <View style={styles.container}>
                    <View>
                        ...
                        {/* <View><Text>{pergunta_txt.map(item=><Text>{item.titulo}</Text>)}</Text></View>  */}
                            ...
                            <TouchableOpacity style={styles.primaryButton} onPress={() => {save();navigation.navigate ("Limpeza")}}>
