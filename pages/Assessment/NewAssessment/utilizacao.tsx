...
import {
  ...
  postData('/avaliacao/ultilizacao', /*Inserir aqui o JSON com a Flatlist de avaliacoes da ultilizacao*/)
    .then(data => {
  ...
  export default function Utilização({navigation}) {
    ...
    const [formUtilizacao, setQuestion] = useState([
        ...
        <ScrollView>
            <View style= {{backgroundColor: '#fff'}}> 
                <View style={styles.container}>
                    <View>
                        <Text style= {{ fontSize: 18, fontWeight: 'bold' }}> Utilização</Text>
                    </View>
                    <FlatList
                    ...
                    />
                    <TouchableOpacity style={styles.primaryButton} onPress={() => navigation.navigate ("Disciplina")}>
