...
import {
  ...
  export default function Utilização({navigation}) {
    
    const [pergunta_txt, setPergunta] = useState([0,0,0,0]);

    useEffect(() => {
        const fetchData = async () => {
            const response = await pergunta.get('/1')
    ...
    const [descricao_txt, setDescricao] = useState({1.1:[0,0,0,0,0]});
    useEffect(() => {
        const fetchData2 = async () => {
            const response = await descricao.get('/1')
    ...
    const renderCondL1 = () => {
        switch (l1) {
            case 1:
                ...
                <Text style = {styles.BodyTextSecondary}>{descricao_txt["1.1"][0].descricao}</Text>
                    </View>
                )
                break;
             case 2:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}>{descricao_txt["1.1"][1].descricao} </Text>
                    </View>
                )
                break;
             case 3:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}>{descricao_txt["1.1"][2].descricao} </Text>
                    </View>
                )
                break;
             case 4:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}> {descricao_txt["1.1"][3].descricao} </Text>
                    </View>
                )
                break;
             case 5:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}> {descricao_txt["1.1"][4].descricao}</Text>
                    </View>
                )
                break;
            default:
        ...
        switch (l2) {
            case 1:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}>{descricao_txt["1.2"][0].descricao}</Text>
                    </View>
                )
                break;
             case 2:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}> {descricao_txt["1.2"][1].descricao} </Text>
                    </View>
                )
                break;
             case 3:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}> {descricao_txt["1.2"][2].descricao} </Text>
                    </View>
                )
                break;
             case 4:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}> {descricao_txt["1.2"][3].descricao} </Text>
                    </View>
                )
                break;
             case 5:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}> {descricao_txt["1.2"][4].descricao} </Text>
                    </View>
                )
                break;
            default:
        ...
        switch (l3) {
            case 1:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}>{descricao_txt["1.3"][0].descricao}</Text>
                    </View>
                )
                break;
             case 2:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}>  {descricao_txt["1.3"][1].descricao} </Text>
                    </View>
                )
                break;
             case 3:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}> {descricao_txt["1.3"][2].descricao} </Text>
                    </View>
                )
                break;
             case 4:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}> {descricao_txt["1.3"][3].descricao} </Text>
                    </View>
                )
                break;
             case 5:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}> {descricao_txt["1.3"][4].descricao} </Text>
                    </View>
                )
                break;
            default:
        ...
        switch (l4) {
            case 1:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}>{descricao_txt["1.4"][0].descricao}</Text>
                    </View>
                )
                break;
             case 2:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}> {descricao_txt["1.4"][1].descricao} </Text>
                    </View>
                )
                break;
             case 3:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}> {descricao_txt["1.4"][2].descricao} </Text>
                    </View>
                )
                break;
             case 4:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}> {descricao_txt["1.4"][3].descricao} </Text>
                    </View>
                )
                break;
             case 5:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}> {descricao_txt["1.4"][4].descricao} </Text>
                    </View>
                )
                break;
            default:
        ...
        switch (l5) {
            case 1:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}>{descricao_txt["1.5"][0].descricao}</Text>
                    </View>
                )
                break;
             case 2:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}> {descricao_txt["1.5"][1].descricao} </Text>
                    </View>
                )
                break;
             case 3:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}> {descricao_txt["1.5"][2].descricao} </Text>
                    </View>
                )
                break;
             case 4:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}> {descricao_txt["1.5"][3].descricao} </Text>
                    </View>
                )
                break;
             case 5:
                return (
                    <View style={styles.commentBox}>
                        <Text style= {styles.h4}>Descrição da nota</Text>
                        <Text style = {styles.BodyTextSecondary}> {descricao_txt["1.5"][4].descricao} </Text>
                    </View>
                )
                break;
            default:
    ...
    const save = async() => { //fazer um post pro back
        ...
        avaliacao.post('/u', {Question_id_answer_u: {notas:[l1,l2,l3,l4], justificativas:[text1,text2,text3,text4] }}).then(response => {console.log(response)})}
        ...
        <ScrollView>
            <View style= {{backgroundColor: '#fff'}}> 
                <View style={styles.container}>
                    <View>
                        <Text style= {styles.h2}> Utilização</Text>
                        </View>
                        <View>
