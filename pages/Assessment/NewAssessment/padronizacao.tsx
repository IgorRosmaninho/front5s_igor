...
import {
  ...
  export default function Padronização({navigation}) {
    ...
    const [descricao_txt, setDescricao] = useState({4.1:[0,0,0,0,0]});
    useEffect(() => {
        const fetchData2 = async () => {
            const response = await descricao.get('/4')
                    ...
                    <View>
                        ...
                        {/* <View><Text>{pergunta_txt.map(item=><Text>{item.titulo}</Text>)}</Text></View>  */}
                            ...
                            {renderCondL1()}
                             ...
                             <TouchableOpacity style={styles.secondaryButton} onPress={() => navigation.navigate ("Evidencia",{ titulo: 4.1 })} > 
                            ...
                            {renderCondL2()}
                             ...
                             <TouchableOpacity style={styles.secondaryButton} onPress={() => navigation.navigate ("Evidencia",{ titulo: 4.2 })} > 
                                 <Text style={styles.secondaryButtonText}>Adicionar evidência</Text>
                             </TouchableOpacity>
                             <View style={styles.divisor}></View>
                            ...
                            {renderCondL3()}
                             ...
                             <TouchableOpacity style={styles.secondaryButton} onPress={() => navigation.navigate ("Evidencia",{ titulo: 4.3 })} > 
                                 <Text style={styles.secondaryButtonText}>Adicionar evidência</Text>
                             </TouchableOpacity>
                             <View style={styles.divisor}></View>
                            ...
                            {renderCondL4()}
                             ...
                             <TouchableOpacity style={styles.secondaryButton} onPress={() => navigation.navigate ("Evidencia",{ titulo: 4.4 })} > 
                                 <Text style={styles.secondaryButtonText}>Adicionar evidência</Text>
                             </TouchableOpacity>
                             <View style={styles.divisor}></View>
                            ...
                            <TouchableOpacity style={styles.primaryButton} onPress={() => {save();navigation.navigate ("Disciplina")}}>
